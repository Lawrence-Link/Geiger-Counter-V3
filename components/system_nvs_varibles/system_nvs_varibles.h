...
public:
    ...
    void set_conf_warn_threshold(bool value) { cpm_warn_threshold = value; }
    void set_conf_dngr_threshold(bool value) { cpm_dngr_threshold = value; }
    void set_conf_hzdr_threshold(bool value) { cpm_hzdr_threshold = value; }
